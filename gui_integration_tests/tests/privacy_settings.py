...
class TestPrivacySettings(BaseTestCase):
  test_env = TestEnv(
     organization = False,
...
#    
#    
  def test_default_environment_privacy_settings__event_list(self):
...
#  def test_changing_privacy_setting(self):
#      pass

class TestPrivacySettings_EventCreator(BaseTestCase):
  test_env = TestEnv(
     organization = True,
     create_new_user = False,
  ...
  def test_event_creator_should_see_all_attendies(self):
    sel = self.selenium
